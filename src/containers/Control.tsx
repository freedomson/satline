        ...
        <Modal
          ...
          <View>
              ...
              <TouchableHighlight
                ...
                <Icon name={"navigate-next"} raised={true} reverse={true} iconStyle={[styles.ButtonIcon]} />
              </TouchableHighlight>
               ...
               <TouchableHighlight
                ...
                <Icon name={"navigate-before"} raised={true} reverse={true} iconStyle={[styles.ButtonIcon]} />
              </TouchableHighlight>
